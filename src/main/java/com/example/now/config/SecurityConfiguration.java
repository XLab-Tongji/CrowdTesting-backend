...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/question/add-resource","/task/add-resource","/image/add-album","/image/change-album-name","/image/findImages","/image/add-image","/image/delete-image","/question/see-all-answer","/put-image","/question/add-question","/question/add-option","/requester/update", "/requester/find-myself", "/task/add", "/task/update", "/task/delete", "/task/find-my-task", "/taskData/add").hasRole("REQUESTER")
                .antMatchers("/question/answer-one","/question/select-one","/task/read-resource","/question/see-my-answer","/worker/update", "/worker/find-myself", "/personal-task/add", "/personal-task/find-my-task","/question/finish").hasRole("WORKER")
