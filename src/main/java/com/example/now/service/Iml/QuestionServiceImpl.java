...
public class QuestionServiceImpl implements QuestionService{
    ...
    @Override
    public String addQuestionToTask(int taskId,String content,int resourceLoading,int type,int compulsory,int questionNumber,IdStore made){
        Question question=new Question(content,resourceLoading,type,taskId,compulsory,questionNumber);
    ...
    public List<QuestionDetail> seeAllQuestion(int taskId){
        ...
        List<Question> questions=questionRepository.findByTaskIdOrderByQuestionNumber(taskId);
        for (Question question:questions){
            QuestionDetail questionDetail=new QuestionDetail(question,optionRepository.findByQuestionIdOrderByOptionNumber(question.getId()));
    ...
    public List<QuestionDetail> seeAllQuestion(int taskId,int workerId){
        ...
        for (Question question:questions){
            ...
            for(Option option:optionRepository.findByQuestionIdOrderByOptionNumber(question.getId())){
    ...
    public  List<QuestionDetail> seeAllAnswer(int taskId){
        ...
        for(QuestionDetail question:questionDetails){
            ...
            question.setAnswers(openAnswerRepository.findByQuestionId(question.getQuestion().getId()));
        }
        return questionDetails;
    }
    @Override
    ...
    @Override
    public String answer(int questionId,int workerId,String content){
        OpenAnswer openAnswer=new OpenAnswer(content,questionId,workerId);
        openAnswerRepository.saveAndFlush(openAnswer);
        return "success";
    }
    @Override
